...
<div class="d-flex align-items-center justify-content-between mt-4 mb-3">
	...
	<a href="<%=ctx%>/UsuarioCrearServlet" class="btn btn-primary"> <i
		class="fas fa-user-plus me-1"></i> Alta de Usuario
	</a>
</div>
	...
	<div class="card-body">
		<table id="datatablesSimple" class="table table-striped align-middle">
			...
			<tbody>
				...
				%>
				<tr>
					<td colspan="7" class="text-center text-muted">No hay usuarios
						para mostrar.</td>
				</tr>
				<%
				}
